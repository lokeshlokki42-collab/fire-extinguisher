...
export default function Certification() {
  return <section className="certification-section" id="certification" aria-labelledby="certification-title">
    ...
    <div><p className="eyebrow">TRUSTED PROTECTION</p><h2 id="certification-title">Recognised by<br /><em>Kavasam Safety Solutions.</em></h2><p>Read the official Kavasam Safety Solutions certificate for IMSAFE fire-safety products.</p></div>
